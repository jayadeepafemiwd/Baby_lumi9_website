...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,500;1,900&family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400;1,700;1,900&family=Dancing+Script:wght@400;600;700&family=Fredoka:wght@300;400;500;600;700&family=Great+Vibes&family=Plus+Jakarta+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400&family=Josefin+Sans:wght@300;400;600;700&family=Poppins:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        @font-face {
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:767px){.banner-img{max-height:260px;}.banner-diaper-img{width:36%;right:4%;bottom:6%;}}
...
var galSwiper = new Swiper('.gallery-swiper',{
    slidesPerView:5,centeredSlides:true,spaceBetween:20,loop:true,grabCursor:true,
    autoplay:{delay:2000,disableOnInteraction:false,pauseOnMouseEnter:true},
    speed:600,
    breakpoints:{0:{slidesPerView:1,spaceBetween:10},480:{slidesPerView:2,spaceBetween:12},768:{slidesPerView:3,spaceBetween:16},1024:{slidesPerView:5,spaceBetween:20}}
});
(function(){
